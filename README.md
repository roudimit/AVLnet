This repo has the implementation of our Interspeech 2021 paper: [AVLnet: Learning Audio-Visual Language Representations from Instructional Videos](https://arxiv.org/abs/2006.09199) [1]. In the near future, it will also contain the implementation of our Interspeech 2021 paper: Cascaded Multilingual Audio-Visual Learning from Videos [2]. Our website [avlnet.csail.mit.edu](avlnet.csail.mit.edu) will have more details and an audio-video retrieval demo.
...
- Code, model weights, and data to evaluate AVLnet on YouCook2, MSR-VTT, and CrossTask.
...
- Code and model weights to fine-tune and evaluate AVLnet on Places Audio. This model will work with 2D features only. Please check [1] for the results on Places.
- Code, model weights, and data to evaluate AVLnet on YouCook-Japanese [2].
...
## AVLnet Training and Evaluation on YouCook2, MSR-VTT, and CrossTask
...
[1] Rouditchenko, A.\*, Boggust, A.\*, Harwath, D., Chen, B., Joshi, D., Thomas, S., Audhkhasi, K., Kuehne, H., Panda, R., Feris, R., Kingsbury, B., Picheny, M., Torralba, A., Glass, J. [AVLnet: Learning Audio-Visual Language Representations from Instructional Videos](https://arxiv.org/abs/2006.09199). Interspeech 2021.

[2] Rouditchenko, A., Boggust, A., Harwath, D., Thomas, S., Kuehne, H., Chen, B., Panda, R., Feris, R., Kingsbury, B., Picheny, M., Glass, J. Cascaded Multilingual Audio-Visual Learning from Videos. Interspeech 2021.
...
Cascaded Multilingual Audio-Visual Learning from Videos - Bibtex: TBD
